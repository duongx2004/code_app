...
class _QuizListScreenState extends State<QuizListScreen> {
  ...
  void _applyQuizFilters() {
    ...
    setState(() {
      filteredQuizzes = quizzes.where((quiz) {
        ...
        final difficulty = quiz.difficulty.trim().toLowerCase();
        return difficulty.isNotEmpty && difficulty == _selectedDifficulty.toLowerCase();
      }).toList();
    });
  }
  ...
  Widget _buildQuizCard(Quiz quiz, bool isCompleted) {
    final title = quiz.title.replaceAll('\n', ' ').trim();
    final description = quiz.description.replaceAll('\n', ' ').trim();
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(isCompleted ? Icons.check : Icons.quiz, color: Colors.white),
                    ),
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isCompleted ? AppTheme.textSecondaryLight : AppTheme.textPrimaryLight,
                ...
                Align(
                  ...
                  child: Icon(Icons.arrow_forward_ios, color: AppTheme.primaryColor, size: 16),
                ),
              ],
            ),
          ),
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Icon(Icons.quiz, color: AppTheme.primaryColor, size: 20),
                            ),
                          ...
                          : filteredQuizzes.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return _buildQuizCard(quiz, isCompleted);
                                  },
                                ),
                    ),
                  ),
